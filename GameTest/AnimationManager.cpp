...
void AnimationManager::InitializePlayer() {
    ...
    player->CreateAnimation(static_cast<int>(PlayerAnimation::WALK), 1.0f / 12.0f, { 0, 1, 2, 3, 4, 5 });
    player->CreateAnimation(static_cast<int>(PlayerAnimation::WALK_BACK), 1.0f / 12.0f, { 6,7,8,9,10,11 });
